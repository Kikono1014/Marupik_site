...
urlpatterns = [
			...
			path('news/delete/comment/<int:news_id>/<int:comment_id>',views.delete_comment,  name='comment_delete'),
			path('news/edit/comment/<int:news_id>/<int:comment_id>',views.edit_comment,  name='comment_edit'),
